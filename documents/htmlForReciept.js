module.exports = ({ nameFrom, summa, emailFrom, cardId , paymentStatusUpdate}) => {
       ...
       <head>
          ...
          <style>
            ...
            box-shadow: 1px 1px 10px rgba(250, 200, 132, 0.8);
             ...
             background: rgba(250, 200, 132, 0.8);
             border-bottom: 1px solid rgb(186, 147, 94);
             font-weight: bold;
             }
             ...
             border-bottom: 1px solid rgba(250, 200, 132, 0.8);
             }
       ...
       <body>
          <div class="invoice-box">
             <table cellpadding="0" cellspacing="0">
                ...
                <tr class="information">
                   <td colspan="2">
                      <table>
                         <tr>
                            <td>
                               Customer name: ${nameFrom} e-mail: ${emailFrom}
                            </td>
                            <td>
                               Receipt number: ${cardId}
                            </td>
                         </tr>
                      </table>
                   </td>
                ...
                <tr class="item">
                   <td>Giftcard MIVIDA BEAUTY</td>
                   <td>${summa} eur</td>
                </tr>
             </table>
             <br />
             <h3 class="justify-center">Total price: ${summa} eur</h3>
          </div>
       </body>
    </html>
    `;
